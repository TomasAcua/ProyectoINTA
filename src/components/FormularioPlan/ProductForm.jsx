...
const ProductForm = ({ fields, productForms, handleInputChange, addProductForm, deleteProductForm, cleanProducts, handleCargarProductos }) => {
    return (
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-2">
                        {fields.map(field => (
                            <div key={field.key}>
                                ...
                                {product.errors[field.key] && <p className="text-red-500 text-xs">{product.errors[field.key]}</p>}
                            </div>
                        ))}
                    </div>
