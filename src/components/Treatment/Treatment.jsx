...
const TreatmentList = ({
  ...
  const labelTratamiento =
    type === "Costo Maquinarias" ? "tratamientos" : "tratamientos";
              ...
              {treatments.slice(0, maxItems || 3).map((treatment, index) => (
                ...
                >
                  ...
                  <div className="mt-1 text-sm text-gray-600">
                    {treatment.productos.length} productos | Total: USD $
                    {treatment.costoTotal?.toFixed(2) || 0}
                  </div>
                </div>
              ))}
    ...
    <div className="p-6 w-full rounded-2xl mb-8">
      {plans.length === 0 ? (
        <p className="text-center text-gray-600">
          No hay tratamientos cargados aún.
        </p>
      ) : (
          ...
          {plans.map((plan, planIx) => (
            <div key={planIx} className="w-full">
              ...
              {plan.tratamientos.map((treatment, treatmentIdx) => {
                const enEdicion =
                  planIx === editPlan && treatmentIdx === indexTreatment;
                          ...
                          <div className="flex pb-3 border-b border-gray-400">
                            ...
                            {treatment.productos.length > 1 && (
                              <Button
                                ...
                                onClick={() =>
                                  eliminarProducto(idx, treatmentIdx)
                                }
                              >
                                <Trash2 />
                              </Button>
                    ...
                    <div className="mt-6 flex md:flex-row flex-col justify-between items-center font-bold text-gray-800 p-4 rounded">
                      <div className="bg-sky-100 border border-sky-300 rounded-lg p-4">
                        ...
                        <p className="text-xl font-semibold text-gray-800">
                          ...
                          {(treatment.costoTotal * currentDolarValue).toFixed(
                            2
                          )}
                        </p>
                      </div>
                      ...
                      {enEdicion && planIx === editPlan ? (
                        ...
                        <div className="flex justify-between gap-2">
                          ...
                          <Button
                            ...
                            onClick={() =>
                              eliminarTratamiento(planIx, treatmentIdx)
                            }
                          >
